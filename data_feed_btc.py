"""
CryptoHybrid AI -- data_feed_btc.py
...
log = logging.getLogger("CryptoHybrid.DataFeed")
...
class BTCDataFeed:
    """
    CryptoHybrid AI -- BTC/GBP dual-timeframe data feed.
    ...
    def __init__(self) -> None:
        ...
        log.info(
            "CryptoHybrid AI | BTCDataFeed ready | capital=GBP %.2f",
            self.capital_gbp,
        )
    ...
    def initialise(self) -> None:
        ...
        """
        log.info("=== CryptoHybrid AI -- Initialising data feed ===")
        for tf in ("1d", "1h", "5m"):
    ...
    def refresh(self) -> None:
        ...
        """
        log.info("=== CryptoHybrid AI -- Refreshing ===")
        for tf in ("1d", "1h", "5m"):
...
if __name__ == "__main__":
    log.info("CryptoHybrid AI -- data feed test starting...")
    feed = BTCDataFeed()
    feed.initialise()
    feed.print_status()
